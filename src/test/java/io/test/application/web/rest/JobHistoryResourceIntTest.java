package io.test.application.web.rest;

import io.test.application.TestAppApplicationApp;

import io.test.application.domain.JobHistory;
import io.test.application.repository.JobHistoryRepository;
import io.test.application.service.JobHistoryService;
import io.test.application.repository.search.JobHistorySearchRepository;
import io.test.application.service.dto.JobHistoryDTO;
import io.test.application.service.mapper.JobHistoryMapper;
import io.test.application.web.rest.errors.ExceptionTranslator;
...
import static io.test.application.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import io.test.application.domain.enumeration.Language;
/**
...
@SpringBootTest(classes = TestAppApplicationApp.class)
